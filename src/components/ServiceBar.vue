<template>
    <div class="service">
        <div class="container">
            <ul>
                <li><span class="icon-setting"></span>サポートサービス</li>
                <li><span class="icon-7day"></span>サポートサービス</li>
                <li><span class="icon-15day"></span>返品可能</li>
                <li><span class="icon-post"></span>送料無料</li>
            </ul>
        </div>
    </div>
</template>
