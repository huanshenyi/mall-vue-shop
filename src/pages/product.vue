        ...
        <div class="content">
            <div class="item-bg">
                ...
                <p>
                    ...
                    <span>|</span>
                    <a href="javascript:;">何か845</a>
                    <span>|</span>
                    <a href="javascript:;">識別何か</a>
                    <span>|</span>
                </p>
                <div class="price">
      ...
      .item-video{
        ...
        .video-box{
          ...
          .video{
            ...
            top:-50%;
            left:50%;
            transform:translate(-50%,-50%); //真ん中寄せの書き方
            z-index:10;
            width:1000px;
            height:536px;
            opacity:1;
            ...
            .icon-close{
              ...
              top:20px;
              right:20px;
              @include bgImg(30px,30px,'/imgs/icon-close.png');
              cursor:pointer;
              z-index:11;
